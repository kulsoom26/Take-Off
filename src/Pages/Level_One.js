...
const LevelOne = () => {
  ...
  return (
    <Container>
      ...
      <List>
        <ListItem>
          A credit account with $1,000 reported credit line for lowering credit
      ...
      <Details>
        ...
        <DetailItem>12-month plan at $10 per month</DetailItem>
      ...
      >
        <ModalContainer>
          ...
          <ModalButton onClick={handleBack}>Submit</ModalButton>
        </ModalContainer>
      </Modal>
    </Container>
  );
